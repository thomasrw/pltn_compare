...
/work/thoma525/main_no_P.py CAV$PERCENT"_${j}""_${SIZE}" /work/thoma525/demand/CAV$PERCENT"_${j}" $SIZE /work/thoma525/demand/ /work/thoma525/ /home/thoma525/myconfig /home/thoma525/mysimpla.cfg.xml /home/thoma525/myOUT-route.xml /home/thoma525/detPOI_OUT.xml /home/thoma525/valCount.xml --nogui
...
while [ $l -lt $j ]
do
#rm /work/thoma525/CAV$PERCENT"_${l}""_${SIZE}""_tripinfo" #keep tripinfo for eval of other runs
...
#todo final clean up
#rm /work/thoma525/CAV$PERCENT"_${j}""_${SIZE}""_tripinfo" #keep tripinfo for eval of other runs
