...
#SBATCH --array=1-100
#SBATCH --partition=defq-48core #temp during defq maintenance
...
##SBATCH -x /work/public/exclude_defq #avoids use of partner nodes subj to suspension #temp remove during defq maintenance
